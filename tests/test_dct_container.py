...
class TestDCTContainer:
    ...
    def test_basic_dct_container(self):
        ...
        objContainer = DCTContainer(
            date_checkers=[CheckIsLunchTime(), CheckIsDinnerTime()],
            date_transformers=[Transform1Hour(), Transform1Hour()],
        )

        dt_lunch = dt.datetime(year=2024, month=7, day=24, hour=12)
        ...
        dt_dinner = dt.datetime(year=2024, month=7, day=24, hour=17)
