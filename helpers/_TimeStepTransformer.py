...
class TimeStepTransformer:
    ...
    def __init__(self, start_datetime: dt.datetime, end_datetime: dt.datetime):
    ...
    def transform(self, input_datetime: dt.datetime, subject: str, topic: str) -> bool:
        ...
        if (input_datetime - self.start_datetime).total_second() < 0 or (
            self.end_datetime - input_datetime
        ).total_second() < 0:
            return None
