...
class datestep:
    ...
    def __init__(self, input_datetime: dt.datetime, current_step: Optional[str] = None):
    ...
    def get_next_datestep(self) -> Optional[Self]:
        ...
        if index >= len(C_DATESTEPS.keys()) - 1:
            ...
            # cannot use datestep with typehints.
            return type(self)(input_datetime=new_datetime, current_step=new_key)
